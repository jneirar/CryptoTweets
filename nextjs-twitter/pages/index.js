...
export default function Home() {
  const requestToken = () => {
    axios.get(`http://127.0.0.1:5000/request_token`).then((res) => {
  ...
  return (
    <div className="container">
      ...
      <main>
        <h3>Build a Twitter Login Component Using NextJS and Python Flask</h3>
        <br></br>
        <Button onClick={requestToken}>Twitter Login</Button>
      </main>
